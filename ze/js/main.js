    ...
    *------------------------------------------*/
    ...
    var _loop = function _loop() {
        ...
        currentBtn.addEventListener(event, function (e) {
            ...
            var baseCSS = "position: absolute; width: " + btnWidth * 2 + "px; height: " + btnWidth * 2 + "px; transition: all linear 700ms; transition-timing-function:cubic-bezier(0.250, 0.460, 0.450, 0.940); border-radius: 50%; background: var(--color-ripple); top:" + (posMouseY - btnWidth) + "px;\tleft:" + (posMouseX - btnWidth) + "px;\tpointer-events: none; transform:scale(0)";
    ...
    var tween = new TimelineMax()
        .to('.big-circle-svg', 2, {'stroke-dasharray': '4255', 'stroke-dashoffset': '2175'})
        .to('.small-circle-svg--top', .25, {autoAlpha:1}, '-=2')
